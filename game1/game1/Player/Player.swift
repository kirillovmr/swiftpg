...
class Player : SKSpriteNode, GameSprite {
    ...
    init() {
        ...
        let bodyTexture = textureAtlas.textureNamed("alienGreen_walk2")
...
//            textureAtlas.textureNamed("alienGreen_walk1"),
            textureAtlas.textureNamed("alienGreen_walk2"),
            textureAtlas.textureNamed("alienGreen_swim1"),
            textureAtlas.textureNamed("alienGreen_swim2"),
            textureAtlas.textureNamed("alienGreen_swim1"),
//            textureAtlas.textureNamed("alienGreen_walk2"),
        ]
        ...
        let soarFrames: [SKTexture] = [textureAtlas.textureNamed("alienGreen_swim1")]
        ...
        let startDie = SKAction.run {
            ...
            self.texture = self.textureAtlas.textureNamed("alienGreen_duck")
