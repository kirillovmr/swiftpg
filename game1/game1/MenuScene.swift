...
class MenuScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        let backgroundImage = SKSpriteNode(imageNamed: "backgroundColorDesert")
        ...
        logoText.text = "Swifty Alien"
        logoText.position = CGPoint(x: 0, y: 100)
        logoText.fontSize = 60
        logoText.fontColor = UIColor.black
        ...
        logoTextBottom.fontColor = UIColor.black
